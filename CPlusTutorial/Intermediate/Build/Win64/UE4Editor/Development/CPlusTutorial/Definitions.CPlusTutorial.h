...
#define UE_PROJECT_NAME CPlusTutorial
#define UE_TARGET_NAME CPlusTutorialEditor
#define UE_MODULE_NAME "CPlusTutorial"
...
#define CPLUSTUTORIAL_API DLLEXPORT
